...
# Funktion zum Erfassen des Bildschirmbereichs eines Fensters
...
# Funktion zum Bewegen der Maus
def move_mouse_to(dx, dy):
    win32api.mouse_event(win32con.MOUSEEVENTF_MOVE, dx, dy, 0, 0)

# Modell laden
model = YOLO(r"Your Path to the Model File (yolov5s.pt)")

# Bildschirmauflösung
screen_width = 1920
screen_height = 1080

# Erfassen des Bildschirms von Counter-Strike 2
window_title = 'Counter-Strike 2'
size_scale = 1  # Größenanpassung des Bildschirmshots (optional)

# Modell warmlaufen lassen (Warmup)
...
def process_frame(screen_image):
    ...
    for result in results:
        ...
        # Iterate over each bounding box and class
...
# Kontinuierliche Erfassung und Objekterkennung
def main_loop():
